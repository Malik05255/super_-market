...
data class ProductInfo(
    ...
    val hasUsefulData: Boolean
        get() = !manufacturingCountry.isNullOrBlank() || !manufacturingPlaces.isNullOrBlank() ||
            !ingredients.isNullOrBlank() || allergens.isNotEmpty() || positiveNotes.isNotEmpty() ||
            cautionNotes.isNotEmpty() || !nutritionGrade.isNullOrBlank() || novaGroup != null
}
