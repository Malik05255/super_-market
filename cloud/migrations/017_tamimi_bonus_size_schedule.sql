-- Route the two active retailers to their production collectors.
-- LuLu uses the shared scoped collector; Tamimi uses the bonus-size-aware collector.
...
begin
    if not (
        (p_retailer = 'lulu' and p_function = 'scoped-identity-ingest')
        or
